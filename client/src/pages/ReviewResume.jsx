     ...
     text-slate-700'>
      ...
      {/*left column*/}
        <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
          ...
          <p className='mt-6 text-sm font-medium'>Update Resume</p>
          ...
          <input onChange={(e)=>setInput(e.target.files[0])} type="file" accept='application/pdf' className='w-full p-2 px-3 mt-2 outline-none text-sm
           rounded-md border border-gray-300 text-gray-600' required/>
            ...
            <p className='text-xs text gray-500 font-light mt-1'>Supports PDF 
              Resume only.</p>
            
            <button className='w-full flex justify-center gap-2 bg-gradient-to-r from-[#00DA83] to-[#009BB3]
             text-white p-4 py-2 mt-6 text-sm rounded-lg cursor-pointer'>
              {
