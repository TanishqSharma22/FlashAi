     ...
     text-slate-700'>
      ...
      {/*left column*/}
        <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
          ...
          <p className='mt-6 text-sm font-medium'>Update image</p>
          ...
          <input onChange={(e)=>setInput(e.target.files[0])} type="file" accept='image/*' className='w-full p-2 px-3 mt-2 outline-none text-sm
           rounded-md border border-gray-300 text-gray-600' required/>
            ...
            <button disabled={loading} className='w-full flex justify-center gap-2 bg-gradient-to-r from-[#F6AB41] to-[#FF4938]
